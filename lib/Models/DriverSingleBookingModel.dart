...
class DriverSingleBookingModel {
  int? status;
  String? message;
  int? count;
  List<Response>? response;

  DriverSingleBookingModel(
      {this.status, this.message, this.count, this.response});

  DriverSingleBookingModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    print('status$status');
...
class Response {
  String? bookDriverId;
  String? bdId;
  String? show_driver_user_complete_btn;
  String? driver_user_complete;
  String? driver_user_complete_date_time;
  // String? booking_active;
  ...
  String? driver_rating_review_btn_show;
  String? userRating;
  String? userReview;
  ...
  Response(
      ...
      this.catSlug,
      this.catName,
      this.show_driver_user_complete_btn,
      this.driver_user_complete,
      this.driver_user_complete_date_time,
      //this.show_driver_user_complete_btn,
      this.driver_rating_review_btn_show,
  ...
  Response.fromJson(Map<String, dynamic> json) {
    ...
    finalFare = json['final_fare'];
    percentage = json['percentage'];
    driver_rating_review_btn_show = json['driver_rating_review_btn_show'];
    bdId = json['bd_id'];
    amountMsg = json['amountMsg'];
    show_driver_user_complete_btn = json['show_driver_user_complete_btn'];
    driver_user_complete = json['driver_user_complete'];
    driver_user_complete_date_time = json['driver_user_complete_date_time'];
    userId = json['user_id'];
