...
//             "message_send_text": "",
//             "message_new_count": "0",
class UserSingleBookingModel {
  int? status;
  String? message;
  int? count;
  List<Response>? response;

  UserSingleBookingModel(
      {this.status, this.message, this.count, this.response});

  UserSingleBookingModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    print('status$status');
...
class Response {
  ...
  String? bookingDate;
  String? user_rating_review_btn_show;
  String? bookingTime;
  String? fare;
  String? finalFare;
  String? percentage;
  ...
  List<DriverUserInfo>? driverUserInfo;
  String? bidInfoShow;
  ...
  Response(
      ...
      this.user_rating_review_btn_show,
  ...
  Response.fromJson(Map<String, dynamic> json) {
    ...
    user_rating_review_btn_show = json['user_rating_review_btn_show'];
    ...
    if (json['driver_user_info'] != null) {
      ...
      json['driver_user_info'].forEach((v) {
        driverUserInfo!.add(DriverUserInfo.fromJson(v));
      });
    }
...
class DriverUserInfo {
  ...
  DriverUserInfo.fromJson(Map<String, dynamic> json) {
    userId = json['user_id'];
    userSlug = json['user_slug'];
    fname = json['fname'];
    lname = json['lname'];
